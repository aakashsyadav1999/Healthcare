...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            encoder_test= self.features_encoding(input_feature_test_df,target_feature_test_df)
            input_features_encoded_train_df = encoder_train.transform(input_features_train_df)
            input_feature_encoded_test_df = encoder_test.transform(input_feature_test_df)
            ...
            # input_features_scaled_train_arr=preprocessing_obj.fit_transform(input_features_train_df)
            # input_feature_scaled_test_arr=preprocessing_obj.transform(input_feature_test_df)
